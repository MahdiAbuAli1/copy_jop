...
# --- 4. الدوال الأساسية للنظام (تم تبسيطها) ---
...
async def get_answer_stream(request_info: dict) -> AsyncGenerator[Dict, None]:
    ...
    # --- المرحلة 0: الطريق السريع للتحيات والردود الفورية ---
    ...
    # --- المرحلة 1: البحث في قاعدة المعرفة دائماً ---
    ...
    # --- المرحلة 2: بناء السلسلة الموحدة وتشغيلها ---
